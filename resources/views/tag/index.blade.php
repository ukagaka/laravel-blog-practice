                ...
                <div class="row">
                    ...
                    <div class="col-xs-7">
                        ...
                        <div id="example-3_filter" class="dataTables_filter">
                            ...
                            <label><input type="search" class="form-control input-sm" id="search-input" data-searurl="tag"></label>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-bordered">
                    ...
                    @foreach($data as $k => $v)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/tag/cancel/'.$v->id.'?status=0') }}" class="btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm('您确定要删除吗？')">
                                    取消
                                </a>
                            </td>
                        </tr>
                    @endforeach
                        <tr>
                            <td colspan="7">
                                <span class="btn btn-danger btn-single" id="del-all">取消</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <script>
        $("#del-all").click(function(){
            ...
            if(ids){
                ...
                window.location.href = '/tag/cancel/'+ ids + '?status=0';
            }
        });
    </script>

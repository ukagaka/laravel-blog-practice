...
function pet_init(){
    $.getJSON('/interface/getchuncai',function(data){
        if(data.code != 0){
            ...
            var pet_menuchuncai = data.msg.configHtml;
...
!function($) {
    ...
    petWCC.prototype = {
        ...
        pet_getNotice : function(){
            var ukagaka = this;
            $.getJSON('/interface/getnotice',function(data) {
        ...
        pet_getMeasurements:function(){
            var ukagaka = this;
            $.getJSON('/interface/measurements',function(data){
                $("#pet_dialog_chat_loading").css('display', "none");
                $("#pet_tempsaying").css('display', "");
        ...
        pet_getPackage:function(page,limit){
            var ukagaka = this;
            $.getJSON("/interface/package",{page:page,limit:limit},function(data){
                if(data.code == 0){
        ...
        pet_inArray:function(){
            ...
            var ukagaka = this;
            $.getJSON("/interface/talkcon",{talkcon:talkcon},function(data) {
                var txt ;
        ...
        pet_getFood:function(){
            var ukagaka = this;
            $.getJSON("/interface/eat",{type:0},function(data){
                var str='';
                var arr = data.msg;
                var preg = /function/;
                for(var i in arr){
        ...
        pet_eatFood:function(obj){
            var ukagaka = this;
            $.getJSON("/interface/eat",{type:obj},function(data) {
                if(data.code == 0){
        ...
        pet_carryingGoods:function(){
            var ukagaka = this;
            $.getJSON("/interface/carrying",function(data){
                ukagaka.pet_chuncaiSay(data.msg,3);
            });
        },
        /*
        ...
        pet_horoscope:function(horoscope){
            ...
            $.getJSON("/interface/constellation",{type:constellation_type},function(data){
                var ulHtml = '<ul>';
        ...
        pet_calendar:function(){
            $.getJSON("/interface/calendar",function(data){
        ...
        pet_oneiromancy:function(){
            ...
            var ukagaka = this;
            $.getJSON("/interface/oneiromancy",{keyword:keyword},function(data){
        ...
        pet_mission:function(){
            ...
            $("#pet_tempsaying").css('display', "");
            var ukagaka = this;
            $.getJSON('/interface/mission',function(data){
                if(data.code == 0){
        ...
        pet_setFace:function(num){
            obj = '/ukagaka/skin/'+pet_name+'/face'+num+'.gif';
